  ...
  <div class="min-h-screen flex items-center justify-center p-4">
    <div class="glass-panel p-10 max-w-xl w-full gold-glow">
      <div class="text-center mb-8">
        ...
        <p class="text-gray-400">انضم إلى فريقك المفضل للمشاركة في المسابقات</p>
      </div>
      ...
      <div v-if="success" class="text-center py-10 animate-fade-in">
        ...
        <router-link to="/" class="bg-ramadan-gold text-ramadan-blue px-8 py-3 rounded-xl font-bold">العودة للرئيسية</router-link>
      </div>
...
const handleRegister = async () => {
  ...
  loading.value = true
  try {
    await axios.post('/api/contestants/register', form.value)
    success.value = true
  } catch (e) {
